...
//1. Atributos o propiedades
	...
	//2. Método constructor. Debe de tener el mismo nombre de laclase, no retorna nada, recibe parámetros (atributos), y los asigna a variables del constructor utilizando la palabra (this).
